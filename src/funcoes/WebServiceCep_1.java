 ...
 */
public final class WebServiceCep_1 {
    ...
    private enum Xml {
        ...
        CIDADE {
                    @Override
                    public void setCep(String text, WebServiceCep_1 webServiceCep) {
         ...
         */
        public abstract void setCep(String text, WebServiceCep_1 webServiceCep);
    }
     ...
     */
    public static WebServiceCep_1 searchCep(String cep) {
        cep = cep.replaceAll("\\D*", ""); //To numeric digits only
        if (cep.length() > 8) {
            cep = cep.substring(0, 8);
        }
        WebServiceCep_1 loadCep = new WebServiceCep_1(cep);
        try {
     ...
     * @param cep
     */
    private WebServiceCep_1(String cep) {
        this.cep = cep;
    }
